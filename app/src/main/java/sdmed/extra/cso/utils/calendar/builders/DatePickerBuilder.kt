package sdmed.extra.cso.utils.calendar.builders
...
import sdmed.extra.cso.utils.calendar.CalendarWeekDay
...
class DatePickerBuilder(
    ...
    onSelectDateListener: IOnSelectDateListener,
    ...
    fun build() = DatePicker(context, calendarProperties, setOnDismissListener)
     ...
     */
    fun previousPageChangeListener(listener: IOnCalendarPageChangeListener) =
    ...
    fun setPreviousPageChangeListener(listener: IOnCalendarPageChangeListener) = previousPageChangeListener(listener)
     ...
     */
    fun forwardPageChangeListener(listener: IOnCalendarPageChangeListener) =
    ...
    fun setForwardPageChangeListener(listener: IOnCalendarPageChangeListener) = forwardPageChangeListener(listener)
